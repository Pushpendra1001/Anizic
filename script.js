...
var page_image = document.querySelector("#bottle-img");

page_image.addEventListener("mouseover" , function(){
    my_cursor.style.opacity = 0;
})

page_image.addEventListener("mouseleave" , function(){
    my_cursor.style.opacity = 1;
})